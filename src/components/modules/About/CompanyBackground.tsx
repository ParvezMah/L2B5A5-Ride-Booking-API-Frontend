    ...
    <section className="py-20 px-4 bg-gradient-to-b from-primary/5 to-background">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold text-foreground mb-6">About Ride Grip</h1>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 text-muted-foreground">
              <p>
                Founded in 2020, Ride Grip emerged from a simple vision: to make transportation accessible, reliable,
              ...
              <p>
                Today, Ride Grip operates in over 50 cities, connecting riders with professional drivers through our
